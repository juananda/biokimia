...
<head>
    ...
    <link href="<?php echo base_url(); ?>ext/vendor/css/blog-post.css" rel="stylesheet">
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Preview Image -->
                <img class="img-fluid rounded" src="<?php echo base_url(); ?>uploads/src/molekul.png" alt="">
                <?php

                    // $config['image_library'] = 'gd2';
                    // $config['source_image'] = 'uploads/src/molekul.png';
    ...
    <script type="text/javascript">console.log("<?php echo $config['source_image'] ?>")</script>
